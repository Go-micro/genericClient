...
type GenericClient interface {
	IsExists(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error)
}
...
func (c *genericClient) IsExists(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := grpc.Invoke(ctx, "/GenericClient.Generic/IsExists", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type GenericServer interface {
	IsExists(context.Context, *Request) (*Response, error)
}
...
func _Generic_IsExists_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Request)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GenericServer).IsExists(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/GenericClient.Generic/IsExists",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GenericServer).IsExists(ctx, req.(*Request))
	}
...
var _Generic_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "IsExists",
			Handler:    _Generic_IsExists_Handler,
		},
	},
...
var fileDescriptor0 = []byte{
	...
	0x5c, 0xec, 0x50, 0xf3, 0x84, 0x6c, 0xb9, 0x38, 0x3c, 0x8b, 0x5d, 0x2b, 0x32, 0x8b, 0x4b, 0x8a,
	0x85, 0xc4, 0xf4, 0x50, 0x6c, 0xd1, 0x83, 0x5a, 0x21, 0x25, 0x8e, 0x21, 0x0e, 0x31, 0x5b, 0x89,
	0x21, 0x89, 0x0d, 0xec, 0x3c, 0x63, 0x40, 0x00, 0x00, 0x00, 0xff, 0xff, 0x4d, 0xd6, 0x86, 0x82,
	0xaf, 0x00, 0x00, 0x00,
}
